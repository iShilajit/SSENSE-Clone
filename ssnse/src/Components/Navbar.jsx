...
<header className="text-gray-600 body-font">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <nav className="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
      <Link to='/Men' className="mr-5 hover:text-gray-900">MENSWEAR</Link>
      <Link to='/Women' className="mr-5 hover:text-gray-900">WOMENWEAR</Link>
      <Link to='/Everything' className="mr-5 hover:text-gray-900">EVERYTHING ELSE</Link>
      <Link to='/sale' className="mr-5 hover:text-gray-900">SALES</Link>
      <Link to='' className="mr-5 hover:text-gray-900">SEARCH</Link>
    </nav>
    ...
    <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
      {/* <button className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Button
       ...
       <Link to='' className="mr-5 hover:text-gray-900">ENGLISH</Link>
       <Link to='/login' className="mr-5 hover:text-gray-900">LOGIN</Link>
       <Link to='' className="mr-5 hover:text-gray-900">WISHLIST</Link>
       <Link to='/shoppingbag' className="hover:text-gray-900">SHOPPING BAG</Link>
    </nav>
    </div>
  </div>
</header>
